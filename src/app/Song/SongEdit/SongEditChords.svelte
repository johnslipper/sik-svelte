<script lang="ts">
  ...
  import type { ChordSection } from "../../Chord/index";
  export let chordSections: ChordSection[] = [];
  ...
  function handleRemoveSection(chordSection: ChordSection) {
  ...
  function removeSection(chordSection: ChordSection) {
